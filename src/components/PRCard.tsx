          ...
          {loadingDetails ? (
            ...
            <>
              ...
              {activeDetailTab === "conflicts" && (
                <ConflictSection conflicts={pr.mergeConflicts} />
              )}
...
const ConflictSection: React.FC<{ conflicts: IMergeConflict[] }> = ({ conflicts }) => {
    ...
    <div className="conflict-panel">
      ...
      <ul className="conflict-list">
        {conflicts.map((conflict) => (
          <li key={conflict.conflictId} className="conflict-item">
